...
export const createHison = (): Hison => {
    return {
        ...
        utils : {
            ...
            addDate(datetime: DateTimeObject | DateObject | string, addValue?: string | number, addType?: string, format?: string): DateTimeObject | string { return hisonCore.utils.addDate(datetime, addValue, addType, format) },
            getDateDiff(datetime1: DateTimeObject | DateObject | string, datetime2: DateTimeObject | DateObject | string, diffType?: string): number { return hisonCore.utils.getDateDiff(datetime1, datetime2, diffType) },
            getMonthName(month: number | string, isFullName?: boolean): string { return hisonCore.utils.getMonthName(month, isFullName) },
            getDateWithFormat(datetime: DateTimeObject | DateObject | string, format?: string): string { return hisonCore.utils.getDateWithFormat(datetime, format) },
            getDayOfWeek(date: DateObject | string, dayType?: string): string { return hisonCore.utils.getDayOfWeek(date, dayType) },
            getLastDay(date: DateObject | string): number { return hisonCore.utils.getLastDay(date) },
            getSysYear(format?: string): string { return hisonCore.utils.getSysYear(format) },
            getSysMonth(format?: string): string { return hisonCore.utils.getSysMonth(format) },
            getSysYearMonth(format?: string): string { return hisonCore.utils.getSysYearMonth(format) },
            getSysDay(format?: string): string { return hisonCore.utils.getSysDay(format) },
            getSysDayOfWeek(format?: string): string { return hisonCore.utils.getSysDayOfWeek(format) },
            getSysHour(format?: string): string { return hisonCore.utils.getSysHour(format) },
            getSysHourMinute(format?: string): string { return hisonCore.utils.getSysHourMinute(format) },
            getSysMinute(format?: string): string { return hisonCore.utils.getSysMinute(format) },
            getSysSecond(format?: string): string { return hisonCore.utils.getSysSecond(format) },
            getSysTime(format?: string): string { return hisonCore.utils.getSysTime(format) },
            getSysDate(format?: string): string { return hisonCore.utils.getSysDate(format) },
