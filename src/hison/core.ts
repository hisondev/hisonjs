...
export const createHison = (): Hison => {
    return {
        ...
        utils : {
            ...
            getFormatDateDash(date: Date): string { return hisonCore.utils.getFormatDateDash(date) },
            getFormatDateCompact(date: Date): string { return hisonCore.utils.getFormatDateCompact(date) },
            ...
            getJSDateObject(datetime: string | Date): Date | null { return hisonCore.utils.getJSDateObject(datetime) },
