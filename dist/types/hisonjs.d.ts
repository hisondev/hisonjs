...
interface BeforePostRequst {
    (requestDw?: InterfaceDataWrapper, options?: Record<string, any>): boolean | void;
}
/**
...
interface InterceptApiResult {
    (result: InterfaceDataWrapper | undefined, response: Response): boolean | void;
}
/**
